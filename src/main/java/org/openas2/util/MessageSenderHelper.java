...
public class MessageSenderHelper
{
	 ...
	 * 
	 * @param idAs2Sender
	 *        identifiant as2 of sender.
	 * @param idAs2Receiver
	 *        identifiant as2 of receiver.
	 * @param messageId
	 *        identifiant of message.
	 * @param subject
	 *        subject of message.
	 * @param body
	 *        content of message.
	 ...
	 *        as2 session.
	 * @throws Exception
	 *         exception occured during the processing.
	 */
			...
			@Nonnull final MimeBodyPart body, @Nonnull final Session session) throws Exception
	{
		...
		session.getProcessor().handle(SenderModule.DO_SEND, as2, null);
	}
	 ...
	 *        sub content type of message (ex: plain, xml).
	 * @return mime body part which contains the prepared message.
	 * @throws Exception
	 *         if an exception occured during the building of message body.
	 */
	@Nonnull
	public MimeBodyPart prepareMessage(@Nonnull final String strMessage, @Nullable final String subContentType)
			throws Exception
	{
